        ...
        <?php
            ...
            if($result){
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    <button type="button" name="approve" class="btn btn-primary">Approve</button>
                    </a>
                    <a href="Decline_User.php?nic='.$nic.'">
                    <button type="button" name="decline" class="btn btn-warning">Decline</button>
                    </a>
        ...
        <?php
            ...
            if($result){
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    <button type="button" name="rework" class="btn btn-dark">Rework</button>
                    </a>
                    <a href="Delete_User.php?nic='.$nic.'">
                    <button type="button" class="btn btn-danger">Remove</button>
                    </a>
